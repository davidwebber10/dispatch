...
vi.mock('@xterm/xterm', () => ({
  Terminal: class { cols = 80; rows = 24; options: Record<string, unknown> = {}; loadAddon() {} open() {} write() {} onData() {} onScroll() { return { dispose() {} }; } onRender() { return { dispose() {} }; } scrollLines() {} scrollToBottom() {} dispose() {} focus() {} },
}));
